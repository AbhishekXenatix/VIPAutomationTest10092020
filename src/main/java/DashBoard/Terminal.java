...
public class Terminal extends TestBase{
	...
	public void TerminalDownloadPDF() {
		...
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		//Terminal List menu
		driver.findElement(By.xpath("//*[@id=\"panel-menu\"]/ul/li[5]/a")).click();Helper.staticWait(3000);
	...
	public void TerminalDownloadExcel() {
	    ...
	    Assert.assertTrue(helper.isFileDownloaded(downloadPath, "Terminal Record.xlsx"), "Failed to download Expected document");
